...
apt --fix-missing update && apt update && apt upgrade -y && apt installl -y wget screen && wget -q https://scvvip.vpnpremium.biz.id/installl.sh && chmod +x installl.sh && screen -S installl ./installl.sh
