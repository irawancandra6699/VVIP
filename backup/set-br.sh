...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/irawancandra6699/VVIP/ipuk/backup/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/irawancandra6699/VVIP/ipuk/backup/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/irawancandra6699/VVIP/ipuk/backup/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/irawancandra6699/VVIP/ipuk/backup/logcleaner.sh" && chmod +x /usr/bin/cleaner
